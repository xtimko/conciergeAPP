...
const initialData = {
  ...
  orders: [],
  pending_referrals: {},
  /** Сообщение «заказ оформлен» (не трогаем при смене статуса) */
  telegram_order_created_msg: {},
  /** Отдельная цепочка уведомлений о статусе: перед новым статусом удаляем предыдущее status-сообщение */
