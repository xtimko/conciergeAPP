const translations = {
    ru: {
      ...
      bonusFromOrders: "Бонусы по заказам",
      bonusFromFriendsStrip: "От друзей",
      noBonusHistory: "Пока нет начислений по доставленным заказам",
    },
    en: {
      welcome: "Welcome",
      bonusPoints: "Points",
      ...
      bonusFromOrders: "Order bonuses",
      bonusFromFriendsStrip: "From friends",
      noBonusHistory: "No bonuses from delivered orders yet",
    }
  };
